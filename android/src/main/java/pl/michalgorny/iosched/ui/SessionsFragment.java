...
import pl.michalgorny.iosched.model.TagMetadata;
import pl.michalgorny.iosched.provider.ScheduleContract;
import pl.michalgorny.iosched.ui.widget.CollectionView;
import pl.michalgorny.iosched.ui.widget.CollectionViewCallbacks;
import pl.michalgorny.iosched.ui.widget.MessageCardView;
import pl.michalgorny.iosched.util.ImageLoader;
import pl.michalgorny.iosched.util.PrefUtils;
import pl.michalgorny.iosched.util.ThrottledContentObserver;
import pl.michalgorny.iosched.util.TimeUtils;
...
import static pl.michalgorny.iosched.util.UIUtils.buildStyledSnippet;
...
public class SessionsFragment extends Fragment implements
    ...
    /**
     * {@link pl.michalgorny.iosched.provider.ScheduleContract.Sessions}
     * query parameters.
     */
