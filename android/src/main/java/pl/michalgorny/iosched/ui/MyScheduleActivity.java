...
import pl.michalgorny.iosched.model.ScheduleHelper;
import pl.michalgorny.iosched.provider.ScheduleContract;
import pl.michalgorny.iosched.ui.widget.MyScheduleView;
import pl.michalgorny.iosched.ui.widget.SlidingTabLayout;
import pl.michalgorny.iosched.util.*;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = "pl.michalgorny.iosched.ARG_CONFERENCE_DAY_INDEX";
    ...
    public static final String EXTRA_DIALOG_TITLE
            = "pl.michalgorny.iosched.EXTRA_DIALOG_TITLE";
    public static final String EXTRA_DIALOG_MESSAGE
            = "pl.michalgorny.iosched.EXTRA_DIALOG_MESSAGE";
    public static final String EXTRA_DIALOG_YES
            = "pl.michalgorny.iosched.EXTRA_DIALOG_YES";
    public static final String EXTRA_DIALOG_NO
            = "pl.michalgorny.iosched.EXTRA_DIALOG_NO";
    public static final String EXTRA_DIALOG_URL
            = "pl.michalgorny.iosched.EXTRA_DIALOG_URL";
