...
import pl.michalgorny.iosched.service.SessionAlarmService;
import pl.michalgorny.iosched.service.SessionCalendarService;
import pl.michalgorny.iosched.ui.widget.CheckableFrameLayout;
import pl.michalgorny.iosched.ui.widget.MessageCardView;
import pl.michalgorny.iosched.ui.widget.ObservableScrollView;
import pl.michalgorny.iosched.util.AccountUtils;
import pl.michalgorny.iosched.util.AnalyticsManager;
import pl.michalgorny.iosched.util.BeamUtils;
import pl.michalgorny.iosched.util.ImageLoader;
import pl.michalgorny.iosched.util.LogUtils;
import pl.michalgorny.iosched.util.SessionsHelper;
...
public class SessionDetailActivity extends BaseActivity implements
    ...
    /**
     * {@link pl.michalgorny.iosched.provider.ScheduleContract.Sessions} query parameters.
     */
