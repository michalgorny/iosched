...
import pl.michalgorny.iosched.nearby.MetadataResolver;
import pl.michalgorny.iosched.nearby.NearbyDeviceManager;
import pl.michalgorny.iosched.ui.widget.ScrimInsetsFrameLayout;
...
public abstract class BaseMapActivity extends BaseActivity implements NearbyFragment.Callbacks, ScrimInsetsFrameLayout.OnInsetsCallback {
    ...
    public static final String EXTRA_DETACHED_MODE
            = "pl.michalgorny.iosched.EXTRA_DETACHED_MODE";
