...
package pl.michalgorny.iosched.service;
...
import pl.michalgorny.iosched.ui.BaseMapActivity;
import pl.michalgorny.iosched.ui.BrowseSessionsActivity;
import pl.michalgorny.iosched.ui.MyScheduleActivity;
import pl.michalgorny.iosched.ui.SessionFeedbackActivity;
import pl.michalgorny.iosched.util.FeedbackUtils;
...
public class SessionAlarmService extends IntentService
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "pl.michalgorny.iosched.action.NOTIFY_SESSION";
    public static final String ACTION_NOTIFY_SESSION_FEEDBACK =
            "pl.michalgorny.iosched.action.NOTIFY_SESSION_FEEDBACK";
    public static final String ACTION_SCHEDULE_FEEDBACK_NOTIFICATION =
            "pl.michalgorny.iosched.action.SCHEDULE_FEEDBACK_NOTIFICATION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "pl.michalgorny.iosched.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "pl.michalgorny.iosched.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "pl.michalgorny.iosched.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "pl.michalgorny.iosched.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "pl.michalgorny.iosched.extra.SESSION_ALARM_OFFSET";
    public static final String EXTRA_SESSION_ID =
            "pl.michalgorny.iosched.extra.SESSION_ID";
    public static final String EXTRA_SESSION_TITLE =
            "pl.michalgorny.iosched.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "pl.michalgorny.iosched.extra.SESSION_ROOM";
    public static final String EXTRA_SESSION_SPEAKERS =
            "pl.michalgorny.iosched.extra.SESSION_SPEAKERS";
    ...
    private void scheduleAlarm(final long sessionStart,
        ...
        notifIntent.setData(
                new Uri.Builder().authority("pl.michalgorny.iosched")
