...
package pl.michalgorny.iosched.provider;

import pl.michalgorny.iosched.appwidget.ScheduleWidgetProvider;
import pl.michalgorny.iosched.provider.ScheduleContract.Announcements;
import pl.michalgorny.iosched.provider.ScheduleContract.PeopleIveMet;
import pl.michalgorny.iosched.provider.ScheduleContract.Blocks;
import pl.michalgorny.iosched.provider.ScheduleContract.Experts;
import pl.michalgorny.iosched.provider.ScheduleContract.Feedback;
import pl.michalgorny.iosched.provider.ScheduleContract.MapMarkers;
import pl.michalgorny.iosched.provider.ScheduleContract.MapTiles;
import pl.michalgorny.iosched.provider.ScheduleContract.Rooms;
import pl.michalgorny.iosched.provider.ScheduleContract.SearchSuggest;
import pl.michalgorny.iosched.provider.ScheduleContract.Sessions;
import pl.michalgorny.iosched.provider.ScheduleContract.Speakers;
import pl.michalgorny.iosched.provider.ScheduleContract.Tags;
import pl.michalgorny.iosched.provider.ScheduleDatabase.SessionsSearchColumns;
import pl.michalgorny.iosched.provider.ScheduleDatabase.SessionsSpeakers;
import pl.michalgorny.iosched.provider.ScheduleDatabase.Tables;
import pl.michalgorny.iosched.util.SelectionBuilder;
...
import pl.michalgorny.iosched.Config;
import pl.michalgorny.iosched.provider.ScheduleContract.*;
import pl.michalgorny.iosched.util.AccountUtils;
...
import static pl.michalgorny.iosched.util.LogUtils.LOGD;
import static pl.michalgorny.iosched.util.LogUtils.LOGV;
import static pl.michalgorny.iosched.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link pl.michalgorny.iosched.sync.SyncHelper}, and queried by various
